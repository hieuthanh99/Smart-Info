...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int? errorCode, String error) failure,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int? errorCode, String error)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class __$$SuccessCopyWithImpl<T, $Res>
  ...
  $Res call({
    ...
    return _then(_$Success<T>(
      freezed == data ? _value.data : data as T,
    ));
  }
}
...
abstract class _$$FailureCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({int? errorCode, String error});
}
...
class __$$FailureCopyWithImpl<T, $Res>
  ...
  $Res call({
    ...
    return _then(_$Failure<T>(
      errorCode: freezed == errorCode ? _value.errorCode : errorCode as int?,
      error: null == error ? _value.error : error as String,
    ));
  }
}

class _$Failure<T> implements Failure<T> {
  const _$Failure({this.errorCode, required this.error});
  ...
  @override
  String toString() {
    return 'ApiResult<$T>.failure(errorCode: $errorCode, error: $error)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, errorCode, error);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return failure?.call(errorCode, error);
  }
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure({final int? errorCode, required final String error}) =
      _$Failure<T>;
